...
namespace DBLAB_EXAM {
    ...
    public partial class HospitalDataSet3 : global::System.Data.DataSet {
        ...
        public partial class PharmacyDataTable : global::System.Data.TypedTableBase<PharmacyRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PharmacyRow AddPharmacyRow(string DrugName, int Quantity) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PharmacyRow FindByDrugName(string DrugName) {
        ...
        public partial class PharmacyRow : global::System.Data.DataRow {
            ...
            public string DrugName {
                get {
                    return ((string)(this[this.tablePharmacy.DrugNameColumn]));
                }
                set {
                    this[this.tablePharmacy.DrugNameColumn] = value;
                }
            }
            ...
            public int Quantity {
                get {
                    return ((int)(this[this.tablePharmacy.QuantityColumn]));
                }
                set {
...
namespace DBLAB_EXAM.HospitalDataSet3TableAdapters {
    ...
    public partial class PharmacyTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Pharmacy] WHERE (([DrugName] = @Original_DrugName) AND ([Quant" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Pharmacy] ([DrugName], [Quantity]) VALUES (@DrugName, @Quantit" +
                "y);\r\nSELECT DrugName, Quantity FROM Pharmacy WHERE (DrugName = @DrugName)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Pharmacy] SET [DrugName] = @DrugName, [Quantity] = @Quantity WHERE " +
                "(([DrugName] = @Original_DrugName) AND ([Quantity] = @Original_Quantity));\r\nSELE" +
                "CT DrugName, Quantity FROM Pharmacy WHERE (DrugName = @DrugName)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT DrugName, Quantity FROM dbo.Pharmacy";
        ...
        public virtual int Fill(HospitalDataSet3.PharmacyDataTable dataTable) {
        ...
        public virtual HospitalDataSet3.PharmacyDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HospitalDataSet3.PharmacyDataTable dataTable = new HospitalDataSet3.PharmacyDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HospitalDataSet3.PharmacyDataTable dataTable) {
        ...
        public virtual int Delete(string Original_DrugName, int Original_Quantity) {
        ...
        public virtual int Insert(string DrugName, int Quantity) {
            if ((DrugName == null)) {
        ...
        public virtual int Update(string DrugName, int Quantity, string Original_DrugName, int Original_Quantity) {
            if ((DrugName == null)) {
                throw new global::System.ArgumentNullException("DrugName");
            }
            else {
            ...
            if ((Original_DrugName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_DrugName));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Quantity, string Original_DrugName, int Original_Quantity) {
            return this.Update(Original_DrugName, Quantity, Original_DrugName, Original_Quantity);
        }
    }
